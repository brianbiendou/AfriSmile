...
export default function KolofapHome() {
  const { user } = useAuth();
  const [kolofapUser, setKolofapUser] = useState({
    id: 'kolofap-user-1',
  ...
  const [recentTransactions, setRecentTransactions] = useState([
    {
      id: '1',
      sender_id: 'kolofap-user-1',
      receiver_id: 'kolofap-user-2',
      amount: 1,
      type: 'transfer',
      status: 'completed',
    ...
    {
      id: '2',
      sender_id: 'kolofap-user-3',
      receiver_id: 'kolofap-user-1',
      amount: 3,
      type: 'transfer',
      status: 'completed',
