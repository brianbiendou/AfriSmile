...
export default function ContactsModal({ 
  ...
  const loadContacts = async () => {
    setIsLoading(true);
    try {
      // Données de test dynamiques pour les contacts
      const mockContacts = [
        {
          id: '1',
          user_id: kolofapUser.id,
        ...
        },
        {
          ...
          contact_gamertag: 'sarah_k',
          contact_display_name: 'Sarah Koné',
          is_favorite: false,
          created_at: new Date().toISOString(),
        },
        {
          id: '3',
          user_id: kolofapUser.id,
          contact_user_id: 'contact-3',
          contact_gamertag: 'alex_ci',
          contact_display_name: 'Alex Kouassi',
          is_favorite: true,
          created_at: new Date().toISOString(),
        },
        {
          id: '4',
          user_id: kolofapUser.id,
          contact_user_id: 'contact-4',
          contact_gamertag: 'fatou_ba',
          contact_display_name: 'Fatou Ba',
          is_favorite: false,
          created_at: new Date().toISOString(),
        },
      ];
  ...
  // Vérifier si le gamertag est valide pour l'ajout
  const isAddFormValid = newGamertag.trim().length >= 3;
  ...
  const handleAddContact = async () => {
    ...
    try {
      ...
      const newContact = {
        ...
        user_id: kolofapUser.id,
        contact_user_id: 'new-contact-' + Date.now(),
        contact_gamertag: newGamertag.trim(),
        contact_display_name: newGamertag.trim().charAt(0).toUpperCase() + newGamertag.trim().slice(1),
        is_favorite: false,
        created_at: new Date().toISOString(),
      };
                ...
                <View style={styles.addFormRow}>
                  ...
                  <TouchableOpacity 
                    style={[
                      ...
                      !isAddFormValid && styles.addConfirmButtonDisabled
                    ]}
