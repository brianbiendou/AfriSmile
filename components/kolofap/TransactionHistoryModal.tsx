...
export default function TransactionHistoryModal({ 
  ...
  const loadTransactions = async () => {
    setIsLoading(true);
    try {
      // Données de test dynamiques pour l'historique
      const mockTransactions = [
        ...
        },
        {
          ...
          message: 'Demande pour achat groupé',
          reference: null,
        ...
        },
        {
          ...
          type: 'transfer' as const,
          status: 'completed' as const,
          message: 'Cadeau d\'anniversaire',
          reference: null,
          created_at: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), // Il y a 1 semaine
          updated_at: new Date().toISOString(),
        },
      ];
