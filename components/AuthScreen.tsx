...
export default function AuthScreen() {
  ...
  // Comptes de test pour connexion rapide
  const testAccounts = [
    {
      email: 'client@test.ci',
      password: 'password123',
      label: 'Client',
      description: 'Marie Kouassi - 4,279 pts (50 FCFA)',
      icon: User,
      color: '#00B14F',
    },
    {
      ...
      password: 'password123',
      label: 'Prestataire',
      description: 'Tante Marie - 8,559 pts (100 FCFA)',
      icon: Store,
      color: '#FF6B6B',
    },
    {
      ...
      password: 'password123',
      label: 'Admin',
      description: 'Système - 17,118 pts (200 FCFA)',
      icon: Crown,
      color: '#8B5CF6',
    },
  ];
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.quickLoginSection}>
            <Text style={styles.quickLoginTitle}>Connexion rapide</Text>
            <View style={styles.quickLoginButtons}>
              {testAccounts.map((account) => {
                ...
                return (
                  <TouchableOpacity
                    key={account.email}
                    style={[styles.quickLoginButton, { backgroundColor: account.color }]}
                    onPress={() => handleQuickLogin(account)}
                    disabled={loading}
                  >
                    <IconComponent size={20} color="#fff" />
                    <Text style={styles.quickLoginLabel}>{account.label}</Text>
                    <Text style={styles.quickLoginDescription}>{account.description}</Text>
                  </TouchableOpacity>
                );
              })}
            </View>
