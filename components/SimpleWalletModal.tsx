...
export default function SimpleWalletModal({ visible, onClose }: SimpleWalletModalProps) {
  ...
  const transactions = [
    ...
    { id: '2', type: 'payment', amount: -2500, points: -40, date: '2024-01-14', provider: 'Chez Tante Marie' },
    { id: '3', type: 'recharge', amount: 5000, points: 81, date: '2024-01-13', method: 'Orange' },
    { id: '4', type: 'payment', amount: -1800, points: -29, date: '2024-01-12', provider: 'Beauty Palace' },
    { id: '5', type: 'recharge', amount: 15000, points: 242, date: '2024-01-11', method: 'Wave' },
  ];
        ...
        >
          ...
          {showAnimation && (
            <View style={styles.animationOverlay}>
              <Text style={{ position: 'absolute', top: 50, left: 50, color: 'red', fontSize: 20, zIndex: 9999 }}>
                ANIMATION ACTIVE
              </Text>
              {/* Confettis */}
              ...
              >
                ...
                <Animated.Text style={[styles.successText, { transform: [{ scale: pulseAnim }] }]}>
                  +{amount ? fcfaToPoints(parseInt(amount)).toLocaleString() : '0'} points ajoutés !
                </Animated.Text>
              </Animated.View>
            </View>
          )}
